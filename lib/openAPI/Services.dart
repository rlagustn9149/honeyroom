...
class Services {
  ...
  static Future<List<MonthlyRent>> getUsers() async {
    var date = 202104;
    var landcode;
    // 아파트 매매
    String url =
...
class Services2 {
  ...
  static getUsers() async {
    ...
    // 단독/ 다가구 전월세
    // String url =
    //     'http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcSHRent?serviceKey=VsP3C42h0DXIcxUFSjfmt%2F7f5y4Um%2Bvne3HVTGecAlAuTXYShcM1VHSAH5S3yNj%2FW0qHqv7ubtuUQmdRbSYoXg%3D%3D&LAWD_CD=11110&DEAL_YMD=201512';
    //seoulLandcode.length

    for (int i = 15; i <= seoulLandcode.length; i++) {
